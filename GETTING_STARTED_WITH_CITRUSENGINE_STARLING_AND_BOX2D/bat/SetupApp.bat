...
set CERT_NAME="GETTING_STARTED_WITH_CITRUSENGINE_STARLING_AND_BOX2D"
set CERT_PASS=fd
set CERT_FILE="bat\GETTINGSTARTEDWITHCITRUSENGINESTARLINGANDBOX2D.p12"
...
:: Output
set AIR_PATH=air
set AIR_NAME=GETTINGSTARTEDWITHCITRUSENGINESTARLINGANDBOX2D
